    ...
    def __init__(self, protocol_version):
        ...
        for i in range(self.numTopics):
            ...
            if threading.current_thread().ident == g.Client_Fuzzing_Thread_ID and g.cur_client_dependency != None:
                ...
                elif len(g.cur_broker_dependency) == 1 and g.FIELD_WILL_TOPIC in g.cur_broker_dependency["passive"]["field"]:
                    topic = g.cur_broker_dependency["passive"]["field"][g.FIELD_WILL_TOPIC]

...
Dependency_Connect_2 = {  
    "active":  {"flag": "client", "mtype": MSG_TYPE_CONNECT, "field": {FIELD_WILL_TOPIC: None}},
    "passive": {"flag": "both", "mtype": MSG_TYPE_SUBSCRIBE, "field": {FIELD_TOPIC: None}}  
}

all_client_dependency = {
    MSG_TYPE_CONNECT: [Dependency_Connect_1, Dependency_Connect_2],
